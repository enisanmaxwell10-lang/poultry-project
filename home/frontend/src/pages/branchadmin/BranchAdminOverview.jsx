  ...
  return (
    <div>
      <h1 className="text-[1.6rem] font-bold text-[#1A1A1A] tracking-tight">
        Branch <span className="text-[#2D5A27]">Dashboard</span>
      </h1>
      <p className="text-[#9CA3AF] text-[14px] mt-2">Welcome, {user?.name}. Here's your branch overview.</p>
...
export default BranchAdminOverview
